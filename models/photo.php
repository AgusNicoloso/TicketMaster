                ...
                if (in_array($fileExtension, $allowedExtensions)) {
                    if ($photo['size'] < $maxSize) {
                        if (move_uploaded_file($photo["tmp_name"], $file)) {
                            ...
                            $this->direction = $ruta;
                        } else throw new Exception("Error al mover la Foto.");
                    } else throw new Exception("Error, Se excedio el tamaño permitido.");
                } else throw new Exception("Error, formato de foto no permitida.");
            } else throw new Exception("Error, pongale un nombre a la foto.");
