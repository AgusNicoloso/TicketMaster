...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(<?= URl ?>images/tickets.jpg);">
	...
	<section class="cart bgwhite p-t-70 p-b-100">
		...
		<?php if ($buys) {  ?>
			...
			<?php  }  else { ?>
				<h4 class="text-center">No tenes ninguna compra...</h4>
			<?php } ?>
			</div>
		</div>
	</section>
