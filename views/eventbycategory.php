              ...
              <?php } ?>
               ...
               <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                  ...
                  if ($dbevents->getLimit($pageaux,$id)) {
                    ...
                    ?>
                  <div class="row">
                    <?php if(!is_array($list) && $list->getIDCategory()==$id){ ?>
                        ...
                        <div class="block2">
                           <div class="block2-img wrap-pic-w of-hidden pos-relative">
                             <img
                              ...
                              src="<?php echo URl . $list->getPhoto(); ?>"
                              height="320px"
                             >
                    ...
                    <?php $count++;} else { ?>
                      ...
                      <?php if($list[$i]->getIDCategory()==$id){ ?>
                     <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        <div class="block2">
                           <div class="block2-img wrap-pic-w of-hidden pos-relative">
                             <img
                              ...
                              src="<?php echo URl . $list[$i]->getPhoto(); ?>"
                              height="320px"
                             >
                              <div class="block2-overlay trans-0-4">
                                 <div class="block2-btn-addcart w-size1 trans-0-4">
                   ...
                   <?php $count++;} ?>
                     ...
                     <?php } ?>
								...
								<?php } ?>
                   <?php if($count==0){ ?>
                    <h3 class="text-center">No hay eventos para esa categoria...</h3>
                  <?php } ?>
                  <!-- Pagination -->
                  <?php if($count!=0){ ?>
                  ...
                  <?php for($a=1;$a<=ceil(count($total)/9);$a++){ ?>
                    ...
                    <?php }else{ ?>
                     <a href="<?= URl ?>category/see/<?php echo $id; ?>?page=<?php echo $a; ?>" class="item-pagination flex-c-m trans-0-4"><?php echo $a; ?></a>
                     <?php } ?>
                  <?php } ?>
                  </div>
                <?php } ?>
